---
tags: ["#python", "#command-line", "#data-visualization", "#cli", "#documentation", "|", "#tabular-data", "#pretty-print", "#table-formatting"]
---
...
Dick Marinus, Sébastien Cells, Yago González, Andrew Gaul, Wim Glenn,
