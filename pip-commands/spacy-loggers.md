---
tags: ["#spacy", "#logging", "#python", "#nlp", "#opensource", "|", "#spacy-loggers", "#machine-learning-logging", "#training-metrics"]
---
...
| `model_log_interval`   | `Optional[int]`       | Steps to wait between logging model checkpoints to the W&B dashboard (default: `None`). Added in `spacy.WandbLogger.v2`.                                                                                                          |
...
| `model_log_interval`   | `Optional[int]`       | Steps to wait between logging model checkpoints to the ClearML dashboard (default: `None`). Will have no effect without also setting `log_best_dir` or `log_latest_dir`.                                                            |
