...
* serializes `str` without escaping unicode to ASCII, e.g., "" rather than
"\\\u597d"
...
serialization, and orjson still specifies `option=orjson.OPT_NON_STR_KEYS`
...
* twitter.json, 631.5KiB, results of a search on Twitter for "", containing
