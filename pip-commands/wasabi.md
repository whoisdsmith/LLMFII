---
tags: ["#python", "#cli", "#developer-tools", "#open-source", "#documentation", "|", "#console-formatting", "#lightweight-toolkit", "#color-utilities"]
---
...
| `tb_base`         | str                | Name of directory to use to show relative paths. For example, `"thinc"` will look for the last occurrence of `"/thinc/"` in a path and only show path to the right of it. | `None`     |
...
| Argument    | Type                    | Description                                                                          | Default |
| ----------- | ----------------------- | ------------------------------------------------------------------------------------ | ------- |
| `data`      | Iterable[Iterable[str]] | The body, one iterable per row, containing an interable of column contents.           |         |
