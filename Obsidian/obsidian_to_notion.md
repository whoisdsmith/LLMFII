...
aliases:
  - obsidian-to-notion
  - obsidian-to-notion_1717151430604
tags:
  - "#developer-tools"
  - "#api"
  - "#open-source"
...
Share of obsidian to Notion [](README-zh.md)
...
[GitHub - Easychris/obsidian-to-notion: Obsidian Weread Plugin is an plugin to sync Weread() hightlights and annotations into your Obsidian Vault.](https://github.dev/zhaohongxuan/obsidian-weread-plugin)
