...
| :-------------------- | :----------: | :----------: | :----------: |
| **OpenAI** | GPT-n for natural language tasks, Codex for translates natural language to code, and DALL·E for creates and edits original images | [[../pip-commands/openai.md]](https://openai.com/api/) | Paid |
...
| **Anthropic** | Coming soon | [[../pip-commands/anthropic.md]](https://www.anthropic.com/) | Paid |
...
|      Name                | Description  | Url | 
| :-------------------- | :----------: | :----------: |
| **ChatGPT** | ChatGPT  | [[../pip-commands/openai.md]](https://chat.openai.com/) |
...
|      Name                | Description  | Url | 
| :-------------------- | :----------: | :----------: |
| **AI Text Classifier** | The AI Text Classifier is a fine-tuned GPT model that predicts how likely it is that a piece of text was generated by AI from a variety of sources, such as ChatGPT.  | [[../pip-commands/openai.md]](https://platform.openai.com/ai-text-classifier) |
