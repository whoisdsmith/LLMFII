...
[English](AI/readme.md) | [](README_ch.md)
...
[Awesome-AIGC](https://github.com/wshzd/Awesome-AIGC) :  AIGC，...... 
...
[ChineseNLPCorpus](https://github.com/InsaneLife/ChineseNLPCorpus) :  Chinese natural language processing data set is the material for experiments at ordinary times. [Chinese-Word-Vectors](https://github.com/Embedding/Chinese-Word-Vectors) :  100+ Chinese Word Vectors [ChineseNlpCorpus](https://github.com/SophonPlus/ChineseNlpCorpus) :  Collect, organize and publish Chinese natural language processing corpus / data set

[nlp-competitions-list-review](https://github.com/zhpmatrix/nlp-competitions-list-review) :  Resume the top plan of all NLP competitions, only focus on NLP competitions, and keep updating! NLPtop[funNLP](https://github.com/fighting41love/funNLP) :  Chinese and English sensitive words, language detection, Chinese and foreign mobile phone / telephone home / operator query, name inference, gender, mobile phone number extraction, ID card extraction, email extraction, and more ... NLP

[nlp_chinese_corpus](https://github.com/brightmart/nlp_chinese_corpus) :   Large Scale Chinese Corpus for NLP 

[awesome-2vec](https://github.com/MaxwellRebo/awesome-2vec) :  Curated list of 2vec-type embedding models 

[chatbot-list](https://github.com/lizhe2004/chatbot-list) :  Share and introduce the application, architecture and algorithm of intelligent customer service and chat robot in the industry   、、 

[awesome-chatbot-list](https://github.com/aceimnorstuvwxz/awesome-chatbot-list) :   Awesome chatbot resource list 
...
[Awesome-Chinese-NLP](https://github.com/crownpku/Awesome-Chinese-NLP) :  A curated list of resources for Chinese NLP  

[*awesome*_Chinese_medical_*NLP*](https://github.com/GanjinZero/awesome_Chinese_medical_NLP) :  Arrangement of Chinese medical NLP public resources NLP：//////QA////etc 
...
[text-classification-surveys](https://github.com/xiaoqian19940510/text-classification-surveys) :  ， 

[awesome_Chinese_medical_NLP](https://github.com/GanjinZero/awesome_Chinese_medical_NLP) :  NLP：//////QA////etc 
...
[DecryptPrompt](https://github.com/DSXiangLi/DecryptPrompt) :  Prompt&LLM，&，AIGC 

[Awesome-Open-domain-Dialogue-Models](https://github.com/cingtiye/Awesome-Open-domain-Dialogue-Models) :  Awesome Open-domain Dialogue Models， 
...
[GitHub-Chinese-Top-Charts](https://github.com/GrowingGit/GitHub-Chinese-Top-Charts) :  🇨🇳 GitHub chinese top list ，「 / 」，。，，。
...
[Awesome-pytorch-list-CNVersion](https://github.com/xavier-zy/Awesome-pytorch-list-CNVersion) :  Awesome-pytorch-list ...... 
...
[leetcode-master](https://github.com/youngyangyang04/leetcode-master) ： LeetCode Introduction ：200，60w，，50，C++，Java，Python，Go，JavaScript，！🔥🔥 ，！🚀 

[awesome-python-login-model](https://github.com/Kr1s77/awesome-python-login-model) ： 😮python crawlers ，， 

[awesome-spider](https://github.com/facert/awesome-spider) :   crawlers list  
...
[SLAM-All-In-One](https://github.com/zhouyong1234/SLAM-All-In-One) :  SLAM，、、VIO、、、 
...
[spatio-temporal-paper-list](https://github.com/Eilene/spatio-temporal-paper-list) :  Spatio-temporal modeling （graph convolution) 
